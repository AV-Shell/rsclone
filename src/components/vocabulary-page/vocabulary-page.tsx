        ...
        <div className="search__form">
          <div className="search__group">
            ...
            <span className="search__additional">
              <svg className="search__icon bi bi-keyboard" id="switchKeyboardButton" xmlns="http://www.w3.org/2000/svg" width="24" height="38" fill="currentColor" viewBox="0 0 16 16">
