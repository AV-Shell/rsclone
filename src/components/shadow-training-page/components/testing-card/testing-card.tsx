...
const TestingCard: React.FC<trainingCardProps> = (props: trainingCardProps) => {
  const {
    word, wordNumber, totalWords, getAnswer,
  } = props;
      ...
      <div className="wrapper">
        ...
        <div className="training-card">
          <div className="training-card-header">
            <button type="button" className="training-card-header-btn-sound">Звук</button>
            <button type="button" className="training-card-header-btn-keyboard">Клава</button>
            <button type="button" className="training-card-header-btn-difficult">Сложные</button>
            <button type="button" className="training-card-header-btn-delete">Удалить</button>
          </div>
          <div className="training-card-body">
            ...
            <div className="training-card-body-word">
              <div className="training-card-body-word-details">
                ...
                <p className="training-card-body-word-details-translation">
                  {'перевод: '}
                  {word.wordTranslate}
                </p>
                <p className="training-card-body-word-details-transcription">
                  {'транскрипция: '}
                  {word.transcription}
                </p>
              </div>
          ...
          <div className="training-card-footer">
            <button type="button" onClick={() => answer(0)}>Показать Снова</button>
            <button type="button" onClick={() => answer(1)}>Ответить правильно</button>
            <button type="button" onClick={() => answer(2)}>Ответить неправильно</button>
          </div>
        </div>
      </div>
    </div>
